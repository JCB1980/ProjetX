let calcul = function () {
  ...
  vm.component("declaration2033A", {
    props: [
      { id: 0, nom: "Année:", content: Decl2033A[0].annee },
      {
        id: 1,
        nom: "Brut immobilisations corporelles (case 028 ):",
        content: Decl2033A[0].BrutCorporel,
      },
      {
        id: 2,
        nom: "Amortissement immobilisations corporelles (case 030):",
        content: Decl2033A[0].AmorCorporel,
      },
      {
        id: 3,
        nom: "Net immobilisations corporelles:",
        content: Decl2033A[0].NetCorporel,
      },
      {
        id: 4,
        nom: "Brut immobilisations incorporelles (case014):",
        content: Decl2033A[0].BrutIncorporel,
      },
      {
        id: 5,
        nom: "Amortissement immobilisations incorporelles (case 016):",
        content: Decl2033A[0].AmorIncorporel,
      },
      {
        id: 6,
        nom: "Net immobilisations incorporelles:",
        content: Decl2033A[0].NetIncorporel,
      },
      {
        id: 7,
        nom: "Emprunt et dettes assimilées (case 156):",
        content: Decl2033A[0].Emprunt,
      },
    ],
    template: "<p> {{content}}</p>",
  });
  vm.mount("#app"); /* mount est une méthode pour monter l'appli que l'id*/
};
